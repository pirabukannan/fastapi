...
host_server = os.environ.get('host_server', 'fastapi-demo-server.postgres.database.azure.com')
db_server_port = urllib.parse.quote_plus(str(os.environ.get('db_server_port', '5432')))
database_name = os.environ.get('database_name', 'fastapi_db')
db_username = urllib.parse.quote_plus(str(os.environ.get('db_username', 'fastapi_admin')))
db_password = urllib.parse.quote_plus(str(os.environ.get('db_password', 'Apple123m')))
